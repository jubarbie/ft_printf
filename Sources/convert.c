...
/*   Updated: 2018/05/15 14:08:10 by jubarbie         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	convert(char **ret, va_list ap, t_opt *o)
{
	...
	{
		if (o->modif & M_LL)
			*ret = unsigned_conversions(va_arg(ap, unsigned long long), o);
		else if (o->modif & M_L || o->modif & M_J)
			*ret = unsigned_conversions(va_arg(ap, unsigned long int), o);
		else
